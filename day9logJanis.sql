...
MariaDB [csd2204s18]> SELECT first_name, last_name feom employees where manager_id !=0;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'employees where manager_id !=0' at line 1
...
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from locations where country_id = 'US'' at line 1
MariaDB [csd2204s18]> SELECT location_id, from locations where country_id = 'US';
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from locations where country_id = 'US'' at line 1
MariaDB [csd2204s18]> SELECT location_id, from locations where country_id ='US';
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from locations where country_id ='US'' at line 1
...
MariaDB [csd2204s18]> SELECT manager_id from employees where manager-id!=0;
...
MariaDB [csd2204s18]> select first_name, last_name, salary, job_id from employees where salary = (select min_salary from jobs where job_id = );
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near ')' at line 1
...
MariaDB [csd2204s18]> select fisrt_name, last_name,salary,department_id from employees where salary >(select avg(salary) from employees) and department_id IN (select department_id from departments where department name like 'IT%');
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'name like 'IT%')' at line 1
MariaDB [csd2204s18]> select fisrt_name, last_name,salary,department_id from employees where salary >(select avg(salary) from employees) and department_id IN (select department_id from departments where department_name like 'IT%');
